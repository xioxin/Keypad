...
#define USB_CFG_HID_WHEELMOUSE 1
...
#	define USB_CFG_SERIAL_NUMBER 'v', '0', '.', '2', '-', '2', '0', '1', '5', '0', '7', '2', '7', '2', '3', '0', '0', 'Z'
#endif
...
/* look into descriptor.h to fill in correct sizes */
#define USB_CFG_DESCR_PROPS_DEVICE					0

#if ((defined(USB_CFG_HID_NOMOUSE)) && (defined(USB_CFG_HID_NOKEYBOARD)))
#	error With USB_CFG_HID_NOMOUSE and USB_CFG_HID_NOKEYBOARD there is not much of a device!
#else
#	if ((!defined(USB_CFG_HID_NOMOUSE)) && (!defined(USB_CFG_HID_NOKEYBOARD)))
#		define USB_CFG_DESCR_PROPS_CONFIGURATION		(9+2*(9+9+7))
#	else
#		if (!defined(USB_CFG_HID_NOMOUSE))
#			define USB_CFG_DESCR_PROPS_CONFIGURATION	(9+1*(9+9+7))
#		endif
